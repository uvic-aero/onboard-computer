...
class HeatMatrix:
    ...
    def _update_heat_matrix(self, new_frame):
        ...
        self.heat_matrix = (self.heat_matrix /
                            self._get_oldest_frame()) * new_frame
    ...
    def compute_vector(self, new_frame):
        ...
        highest_cord = np.unravel_index(
            np.argmax(self.heat_matrix, axis=None), self.heat_matrix.shape)
