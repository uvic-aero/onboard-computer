...
class Status(web.RequestHandler):
    ...
    def get(self):
        ...
        try:
            self.write({"service": "Timelapse", "status": timelapse.status})
            self.finish()
        except:
...
class Stop(web.RequestHandler):
    ...
    def get(self):
        timelapse.stop()
        try:
            self.write({"service": "timelapse", "action": "Killing"})
            self.finish()
        except:
            print("Error Writing Request Response")
...
class Start(web.RequestHandler):
    ...
    def get(self):
        timelapse.start()
        try:
            self.write({"service": "timelapse", "action": "Starting"})
            self.finish()
        except:
            print("Error Writing Request Response")
...
class SetDuration(web.RequestHandler):
    def set_default_headers(self):
        self.set_header("Access-Control-Allow-Origin", "*")
        self.set_header("Access-Control-Allow-Headers", "x-requested-with,content-type")
        self.set_header("Access-Control-Allow-Methods", "GET, OPTIONS")
    ...
    def get(self):
        try:
            ...
            duration = int(self.get_argument("duration"))
            timelapse.set_duration(duration, interval)
            self.write(
                {
                    "service": "timelapse",
                    "action": "Changing to new temporary interval",
                    "duration": timelapse.duration,
                    "temp interval": timelapse.interval,
                }
            )
            self.finish()
        except:
